...
import { IModuleConfiguration, IClientSideComponentLoaderConfiguration, ILocalizedPathModuleConfiguration } from '@microsoft/sp-module-interfaces';
 ...
 * @internal
 */
export interface ILegacyLocalizedExternal {
    moduleConfiguration: ILocalizedPathModuleConfiguration;
    assets: {
        [name: string]: string;
    };
}
...
export interface IManifestPluginOptions {
     ...
     * @internal
     */
    tryGetLegacyLocalizedExternalByNameAsync?: (name: string) => Promise<ILegacyLocalizedExternal>;
}
/**
 * @internal
 */
