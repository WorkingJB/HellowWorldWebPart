        ...
        for (const module of runtimeChunk.getModules()) {
            ...
            if (externalModule.external) {
                ...
                if (externalComponent) {
                    ...
                    externalManifestModule = externalComponentModule;
                }
                else {
                    const legacyLocalizedExternal = this._options
                        .tryGetLegacyLocalizedExternalByNameAsync
                        ? await this._options.tryGetLegacyLocalizedExternalByNameAsync(externalName)
                        : undefined;
                    if (legacyLocalizedExternal) {
                        externalManifestModule = legacyLocalizedExternal.moduleConfiguration;
                        for (const [assetName, assetContents] of Object.entries(legacyLocalizedExternal.assets)) {
                ...
                scriptResources[externalName] = externalManifestModule;
            }
        }
