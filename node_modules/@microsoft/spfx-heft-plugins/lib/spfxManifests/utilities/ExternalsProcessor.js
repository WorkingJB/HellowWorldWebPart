...
exports.getVersionFunction = exports.getNonStandardExternals = exports.includeNonStandardExternal = void 0;
...
const _nonStandardExternalMap = {
    ...
    tslib: {
        ...
        getFailoverPath: (packageRoot) => path.join(packageRoot, 'tslib.js'),
        getVersion: getVersionFunction('tslib')
    }
};
/**
 * @internal
...
function getVersionFunction(packageName) {
    return (projectRootPath) => {
        try {
            ...
            if (resolvedPath) {
                const packageJson = require(path.join(resolvedPath, 'package.json'));
