...
const LegacyLocalization_1 = require("./legacyLocalization/LegacyLocalization");
...
class ConfigureWebpackTask extends OdspGulpTask_1.OdspGulpTask {
    ...
    async executeTask() {
        ...
        let legacyLocalization;
        if (this.taskConfig.useLegacyLocalization && this.properties.configJson.localizedResources) {
            legacyLocalization = new LegacyLocalization_1.LegacyLocalization({
                gulpTask: this,
                localizedResources: this.properties.configJson.localizedResources,
        ...
        if (config) {
            ...
            legacyLocalization === null || legacyLocalization === void 0 ? void 0 : legacyLocalization.updateWebpackConfiguration(config);
