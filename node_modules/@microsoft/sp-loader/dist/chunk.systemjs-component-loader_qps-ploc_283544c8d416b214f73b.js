...
module.exports = JSON.parse("{\"loadComponentLog\":\"[!!--##Ĺōàďĩńĝ ćōmƥōńēńţ \\u0022{0}\\u0022 ({1}).##--!!]\",\"loadComponentEndLog\":\"[!!--##Ćōmƥōńēńţ \\u0022{0}\\u0022 ({1}) ĺōàďēď.##--!!]\",\"loadComponentRetryLog\":\"[!!--##Ĺōàďĩńĝ ćōmƥōńēńţ \\u0022{0}\\u0022 ({1}). Àţţēmƥţ {2} ōƒ {3}.##--!!]\",\"loadPathDependencyLog\":\"[!!--##Ĺōàďĩńĝ ƥàţĥ ďēƥēńďēńćŷ \\u0022{0}\\u0022 ƒŕōm ćōmƥōńēńţ \\u0022{1}\\u0022 ({2})##--!!]\",\"isUndefinedValidateError\":\"[!!--##Ţĥē vàĺũē ƒōŕ \\u0022{0}\\u0022 mũśţ ńōţ ƀē ũńďēƒĩńēď##--!!]\"}");
...
module.exports = JSON.parse("{\"systemConfigDisabledError\":\"[!!--##Śŷśţēm.ćōńƒĩĝ() ĩś ńōţ śũƥƥōŕţēď. Ũśē à màńĩƒēśţ ţō śƥēćĩƒŷ ţĥē ćōńƒĩĝũŕàţĩōń.##--!!]\"}");
