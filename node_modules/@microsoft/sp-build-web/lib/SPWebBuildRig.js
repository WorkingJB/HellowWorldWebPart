...
class SPWebBuildRig extends SPBuildRig_1.SPBuildRig {
    ...
    getTasks() {
        ...
        result.set(WebBuildRigConstants_1.WebBuildRigConstants.tasks.serve, {
            executable: gulp_core_build_1.serial(spBuildCoreTasks.serve, gulp_core_build_1.watch(exports.serveWatchFilter, gulp_core_build_1.serial(this._preTelemetryTask, result.get(WebBuildRigConstants_1.WebBuildRigConstants.tasks.bundle).executable, gulp_core_build_serve_1.reload, this._postTelemetryTask))),
            arguments: (yargs) => {
                return yargs
                    .option('port', {
        ...
        result.forEach((taskDefinition, name) => {
            result.set(name, {
                executable: gulp_core_build_1.serial(gulp_core_build_1.serial(this._preTelemetryTask), taskDefinition.executable, gulp_core_build_1.serial(this._postTelemetryTask)),
    ...
    getTestTask() {
        return gulp_core_build_1.serial(this.getBundleTask(), gulp_core_build_1.jest);
    }
    getTestOnlyTask() {
        return gulp_core_build_1.serial(gulp_core_build_1.jest);
    }
    getCoreBuildTask() {
        return gulp_core_build_1.parallel(gulp_core_build_1.serial(gulp_core_build_sass_1.default, super.getCoreBuildTask()), gulp_core_build_1.copyStaticAssets);
    }
    getBundleTask() {
        return gulp_core_build_1.serial(this.getBuildTask(), this.getPreWebpackTasks(), spBuildCoreTasks.configureWebpack, gulp_core_build_webpack_1.webpack, this.getPreCopyAssetsTasks(), gulp_core_build_1.parallel(this._postBundleTasks));
    }
    getPreWebpackTasks() {
        return gulp_core_build_1.serial();
    }
