define("4958ea79-6ff3-4480-8291-0932dd010869_1.12.0", ["tslib","@microsoft/sp-loader","@microsoft/sp-core-library","@microsoft/sp-extension-base","@microsoft/sp-diagnostics"], function(__WEBPACK_EXTERNAL_MODULE__17wl__, __WEBPACK_EXTERNAL_MODULE_I6O9__, __WEBPACK_EXTERNAL_MODULE_UWqr__, __WEBPACK_EXTERNAL_MODULE_ZFc5__, __WEBPACK_EXTERNAL_MODULE_ut3N__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/* harmony import */ var _microsoft_sp_extension_base__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @microsoft/sp-extension-base */ "ZFc5");
/* harmony import */ var _microsoft_sp_extension_base__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_microsoft_sp_extension_base__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var _BaseSearchQueryModifier__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./BaseSearchQueryModifier */ "opha");
/* harmony import */ var _SearchQueryModifierContext__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./SearchQueryModifierContext */ "tBLM");
...
var SearchQueryExtensionManager = /** @class */ (function () {
    function SearchQueryExtensionManager(serviceScope) {
        this._extensionManager = new _microsoft_sp_extension_base__WEBPACK_IMPORTED_MODULE_3__["_ExtensionManager"](serviceScope, _BaseSearchQueryModifier__WEBPACK_IMPORTED_MODULE_5__["default"]);
        this._extensions = [];
    }
    /**
    ...
    SearchQueryExtensionManager.prototype.initializeExtensions = function (customActions) {
        var _this = this;
        var qosMonitor = new _microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_2__["_QosMonitor"]('SearchQueryExtensionManager.initializeExtensions');
        var modifierCustomActions = this._getCustomActions(customActions)
            ...
            return ca.location === 'ClientSideExtension.SearchQueryModifier' && // VSO #770394 - Re-use the string
                ...
                !!_microsoft_sp_loader__WEBPACK_IMPORTED_MODULE_4__["SPComponentLoader"].tryGetManifestById(ca.clientSideComponentId);
        })
        ...
        var extensionPromises = modifierCustomActions.map(function (customAction) {
            return _this._extensionManager.createExtension(customAction.clientSideComponentId.toString(), customAction.clientSideComponentProperties, function (params) {
                return new _SearchQueryModifierContext__WEBPACK_IMPORTED_MODULE_6__["default"](params);
            });
        });
    ...
    SearchQueryExtensionManager.prototype._processQuery = function (extension, query, originalQueryText) {
        var qosMonitor = new _microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_2__["_QosMonitor"]('SearchQueryExtensionManager.processQuery');
        ...
        return Promise.race([
            timeoutPromise,
            extension.modifySearchQuery(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, query), { originalQueryText: originalQueryText }), _BaseSearchQueryModifier__WEBPACK_IMPORTED_MODULE_5__["SearchQueryScenario"].SearchResults)
        ])
            .then(function (q) {
        ...
        if (parameterValue) {
            ...
            if (queryValue) {
                for (var _i = 0, _a = Object.keys(queryValue); _i < _a.length; _i++) {
                    var key = _a[_i];
                    var clientSideComponentId = _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_1__["Guid"].tryParse(key);
...
var BaseSearchQueryModifier = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(BaseSearchQueryModifier, _super);
...
var SearchQueryModifierContext = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(SearchQueryModifierContext, _super);
...
/******/ })});;
//# sourceMappingURL=sp-search-extensibility_none_4607508072a6a3202cbb.js.map