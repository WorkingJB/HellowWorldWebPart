define("05ed6956-59ad-4aa6-9e4e-b832c96ae87b_0.7.17", ["@microsoft/sp-core-library"], function(__WEBPACK_EXTERNAL_MODULE_UWqr__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
var A11yManager = /** @class */ (function () {
    ...
    A11yManager.prototype._hasSkipKeyAttribute = function (keyCode, element) {
        var skipAttr = _A11yAttribute__WEBPACK_IMPORTED_MODULE_5__["default"].getAllFromElement(this.prefix, element).filter(function (attr) { return attr.type === _A11yAttribute__WEBPACK_IMPORTED_MODULE_5__["A11yAttributeType"].SkipKeys; })[0];
    ...
    A11yManager.prototype._hasStopKeyAttribute = function (keyCode, element) {
        var stopAttr = _A11yAttribute__WEBPACK_IMPORTED_MODULE_5__["default"].getAllFromElement(this.prefix, element).filter(function (attr) { return attr.type === _A11yAttribute__WEBPACK_IMPORTED_MODULE_5__["A11yAttributeType"].StopKeys; })[0];
    ...
    A11yManager.prototype._navigateByHierarchicalNavigation = function (evt) {
        ...
        if (_keyboard_Keyboard__WEBPACK_IMPORTED_MODULE_3__["default"].isTab(evt) && currentElement.getAttribute('role') !== 'main') {
...
var A11yAttribute = /** @class */ (function () {
    ...
    A11yAttribute.getAllFromElement = function (appPrefix, element) {
        ...
        var types = Object.keys(A11yAttributeType)
            .map(function (k) { return A11yAttributeType[k]; })
    ...
    A11yAttribute._getTypeString = function (type) {
        switch (type) {
            case A11yAttributeType.Id:
                return 'id';
            case A11yAttributeType.Class:
                return 'class';
            case A11yAttributeType.SkipKeys:
                return 'skipkeys';
            case A11yAttributeType.StopKeys:
                return 'stopkeys';
            case A11yAttributeType.AlertOnFocusIn:
                return 'alertonfocusin';
            case A11yAttributeType.AlertOnFocusOut:
                return 'alertonfocusout';
            case A11yAttributeType.NavigateOnKey:
                return 'navigateonkey';
            case A11yAttributeType.NavigateByHierarchy:
                return 'navigatebyhierarchy';
            default:
                throw new Error("Undefined string for attribute type: " + type);
        }
    };
...
var Keyboard = /** @class */ (function () {
    ...
    Keyboard.isKey = function (keyCode, event, allowedModifiers) {
        ...
        if (!Keyboard._isMacCommandKeyFixKillSwitchActivated()) {
            ...
            var isCtrlPressed = Boolean((!isMac && event.ctrlKey && !event.metaKey) || (isMac && event.metaKey && !event.ctrlKey));
...
/* harmony import */ var _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @microsoft/sp-core-library */ "UWqr");
/* harmony import */ var _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _dom_DomTraversal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../dom/DomTraversal */ "ozHI");
...
var Focus = /** @class */ (function () {
     ...
     *   For SVG elements, offsetParent is always null. So we skip this check for SVG element.
    ...
    Focus.isElementFocusable = function (elem, ignoreTabIndex) {
        ...
        if (elem &&
            !elem.hidden &&
            ((!Focus._isAvoidOffsetParentKSActivated() && elem instanceof SVGElement) || elem.offsetParent) &&
    ...
    Focus.getFocusableParent = function (element, root) {
        ...
        var parent = _dom_DomTraversal__WEBPACK_IMPORTED_MODULE_1__["default"].getFirstMatchingParent(element, this.isElementFocusable, root, false);
        return parent || root;
    };
    /**
    ...
    Focus.hasFocus = function (element, checkChildren) {
        ...
        if (checkChildren && _dom_DomTraversal__WEBPACK_IMPORTED_MODULE_1__["default"].contains(element, document.activeElement)) {
            return true;
        }
        return false;
    };
    ...
    Focus._isAvoidOffsetParentKSActivated = function () {
        return _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_0__["_SPKillSwitch"].isActivated('f86c4add-367a-4dce-844e-79ac8f682763' /* '10/26/2020', 'Avoid use offsetParent to determine whether an element is not displayed.' */);
    };
    return Focus;
}());
...
/******/ })});;
//# sourceMappingURL=sp-a11y_none_f092d0a51ccf12a017f0.js.map