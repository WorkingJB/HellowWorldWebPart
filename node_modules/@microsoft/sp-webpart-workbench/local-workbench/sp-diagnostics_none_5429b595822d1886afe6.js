define("78359e4b-07c2-43c6-8d0b-d060b4d577e8_1.12.0", ["@microsoft/sp-lodash-subset","@microsoft/sp-core-library"], function(__WEBPACK_EXTERNAL_MODULE_Pk8u__, __WEBPACK_EXTERNAL_MODULE_UWqr__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/***/ "7DJj":
/*!**************************************!*\
  !*** ./lib/Api/Qos/QosResultType.js ***!
  \**************************************/
/*! exports provided: QosResultType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QosResultType", function() { return QosResultType; });
/**
 ...
 * @internal
 */
// This is quite similar to CurrentPage but these are simplified names that
// we want to build dashboards with.
var PageType;
(function (PageType) {
    PageType["News"] = "News";
    PageType["Article"] = "Article";
    PageType["Home"] = "Home";
    PageType["Space"] = "Space";
...
/* harmony import */ var _extraData_setPageExtraData__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../extraData/setPageExtraData */ "PR7H");
/**
* @copyright Microsoft Corporation.All rights reserved.
...
var EngagementLogger = /** @class */ (function () {
    ...
    EngagementLogger._appendExtraData = function (data) {
        if (_DiagnosticsSettingsManager__WEBPACK_IMPORTED_MODULE_1__["default"].isInitialized) {
            var contextInfo = _DiagnosticsSettingsManager__WEBPACK_IMPORTED_MODULE_1__["default"].settings.contextInfo;
            if (contextInfo) {
                Object(_extraData_setPageExtraData__WEBPACK_IMPORTED_MODULE_2__["setPageExtraData"])(contextInfo, data.extraData);
            }
        }
    };
...
/***/ "PR7H":
/*!*******************************************!*\
  !*** ./lib/extraData/setPageExtraData.js ***!
  \*******************************************/
/*! exports provided: setPageExtraData */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setPageExtraData", function() { return setPageExtraData; });
/* harmony import */ var _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @microsoft/sp-core-library */ "UWqr");
/* harmony import */ var _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _PromotedState__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./PromotedState */ "shDo");
/* harmony import */ var _PageType__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./PageType */ "7RKT");



function setPageExtraData(contextInfo, extraData // tslint:disable-line:no-any
) {
    if (!extraData) {
        extraData = {};
    }
    ...
    if (pageLayoutType === _PageType__WEBPACK_IMPORTED_MODULE_2__["PageType"].Article) {
        if (promotedState === _PromotedState__WEBPACK_IMPORTED_MODULE_1__["PromotedState"].NotPromoted || promotedState === undefined) {
            pageType = _PageType__WEBPACK_IMPORTED_MODULE_2__["PageType"].Article;
        }
        else {
            pageType = _PageType__WEBPACK_IMPORTED_MODULE_2__["PageType"].News;
        }
    }
...
/* harmony import */ var _QosResultType__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./QosResultType */ "7DJj");
/* harmony import */ var _QosLogger__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./QosLogger */ "cUGs");
/* harmony import */ var _Engagement_EngagementLogger__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../Engagement/EngagementLogger */ "O2hE");
/* harmony import */ var _DiagnosticsSettingsManager__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../DiagnosticsSettingsManager */ "ULMK");
// Copyright (c) Microsoft. All rights reserved.
...
var QosMonitor = /** @class */ (function () {
    ...
    function QosMonitor(scenarioName, copyToEngagement) {
        ...
        this._qosResultTypeValue = (_a = {},
            _a[_QosResultType__WEBPACK_IMPORTED_MODULE_2__["QosResultType"].Success] = 'Success',
            _a[_QosResultType__WEBPACK_IMPORTED_MODULE_2__["QosResultType"].Failure] = 'Failure',
            _a[_QosResultType__WEBPACK_IMPORTED_MODULE_2__["QosResultType"].ExpectedFailure] = 'ExpectedFailure',
            _a);
        ...
        if (!this._isDebugSession()) {
            _QosLogger__WEBPACK_IMPORTED_MODULE_3__["default"].instance.startQosMonitor(this._id, { name: scenarioName });
        }
    ...
    QosMonitor.startRealTimeProcessing = function () {
        if (!_QosLogger__WEBPACK_IMPORTED_MODULE_3__["default"].instance.shouldProcessInRealTime) {
            this._shouldProcessInRealTime(true);
        }
    };
    /**
    ...
    QosMonitor._shouldProcessInRealTime = function (processInRealTime) {
        _QosLogger__WEBPACK_IMPORTED_MODULE_3__["default"].instance.shouldProcessInRealTime = processInRealTime;
    };
    ...
    QosMonitor.prototype.writeSuccess = function (extraData) {
        this._writeQosEnd(_QosResultType__WEBPACK_IMPORTED_MODULE_2__["QosResultType"].Success, undefined, undefined, extraData);
    };
    /**
    ...
    QosMonitor.prototype.writeUnexpectedFailure = function (tagNameSuffix, ex, extraData // tslint:disable-line:no-any
        ...
        this._writeQosEnd(_QosResultType__WEBPACK_IMPORTED_MODULE_2__["QosResultType"].Failure, tagNameSuffix, ex, extraData);
    };
    /*
    ...
    QosMonitor.prototype.writeExpectedFailure = function (tagNameSuffix, ex, extraData // tslint:disable-line:no-any
        ...
        this._writeQosEnd(_QosResultType__WEBPACK_IMPORTED_MODULE_2__["QosResultType"].ExpectedFailure, tagNameSuffix, ex, extraData);
    };
    QosMonitor.prototype._writeQosEnd = function (resultType, tagNameSuffix, ex, extraData // tslint:disable-line:no-any
        ...
        _QosLogger__WEBPACK_IMPORTED_MODULE_3__["default"].instance.writeQosEndResult(this._id, endData);
    ...
    QosMonitor.prototype._ensureCorrelationId = function (resultType, extraData // tslint:disable-line:no-any
        ...
        if (_DiagnosticsSettingsManager__WEBPACK_IMPORTED_MODULE_5__["default"].isInitialized && resultType !== _QosResultType__WEBPACK_IMPORTED_MODULE_2__["QosResultType"].Success) {
            ...
            var correlationId = (this._endExtraData && (this._endExtraData[capitalKey] || this._endExtraData[lowerKey])) ||
                _DiagnosticsSettingsManager__WEBPACK_IMPORTED_MODULE_5__["default"].settings.correlationId;
            if (correlationId) {
                if (!this._endExtraData) {
                    this._endExtraData = {};
                }
    ...
    QosMonitor.prototype._writeToEngagement = function () {
        if (this._shouldWriteToEngagement()) {
            ...
            _Engagement_EngagementLogger__WEBPACK_IMPORTED_MODULE_4__["default"].log(engagementData);
        }
    };
...
/*!**********************!*\
  !*** ./lib/index.js ***!
  \**********************/
/*! exports provided: _TraceLogger, _LogEntry, _LogFeature, _LogSource, _logSourceServiceKey, _LogType, _Diagnostics, _PromotedState, _PageType, _LogEvent, _LogLevel, _CircularBuffer, _LogManager, _EngagementLogger, _LogHandler, _QosMonitor, _QosLogger, _QosResultType, _ExecutionQueue */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _extraData_PromotedState__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./extraData/PromotedState */ "shDo");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "_PromotedState", function() { return _extraData_PromotedState__WEBPACK_IMPORTED_MODULE_6__["PromotedState"]; });

/* harmony import */ var _extraData_PageType__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./extraData/PageType */ "7RKT");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "_PageType", function() { return _extraData_PageType__WEBPACK_IMPORTED_MODULE_7__["PageType"]; });

/* harmony import */ var _Api_Trace_LogEvent__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Api/Trace/LogEvent */ "pPvZ");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "_LogEvent", function() { return _Api_Trace_LogEvent__WEBPACK_IMPORTED_MODULE_8__["default"]; });

/* harmony import */ var _Api_LogLevel__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Api/LogLevel */ "rG76");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "_LogLevel", function() { return _Api_LogLevel__WEBPACK_IMPORTED_MODULE_9__["LogLevel"]; });

/* harmony import */ var _Api_LogManager_CircularBuffer__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Api/LogManager/CircularBuffer */ "yF0L");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "_CircularBuffer", function() { return _Api_LogManager_CircularBuffer__WEBPACK_IMPORTED_MODULE_10__["default"]; });

/* harmony import */ var _Api_LogManager_LogManager__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./Api/LogManager/LogManager */ "cyTu");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "_LogManager", function() { return _Api_LogManager_LogManager__WEBPACK_IMPORTED_MODULE_11__["default"]; });

/* harmony import */ var _Api_Engagement_EngagementLogger__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./Api/Engagement/EngagementLogger */ "O2hE");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "_EngagementLogger", function() { return _Api_Engagement_EngagementLogger__WEBPACK_IMPORTED_MODULE_12__["default"]; });

/* harmony import */ var _Api_Log_LogHandler__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./Api/Log/LogHandler */ "qiD/");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "_LogHandler", function() { return _Api_Log_LogHandler__WEBPACK_IMPORTED_MODULE_13__["default"]; });

/* harmony import */ var _Api_Qos_QosMonitor__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./Api/Qos/QosMonitor */ "j5uz");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "_QosMonitor", function() { return _Api_Qos_QosMonitor__WEBPACK_IMPORTED_MODULE_14__["default"]; });

/* harmony import */ var _Api_Qos_QosLogger__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./Api/Qos/QosLogger */ "cUGs");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "_QosLogger", function() { return _Api_Qos_QosLogger__WEBPACK_IMPORTED_MODULE_15__["default"]; });

/* harmony import */ var _Api_Qos_QosResultType__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./Api/Qos/QosResultType */ "7DJj");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "_QosResultType", function() { return _Api_Qos_QosResultType__WEBPACK_IMPORTED_MODULE_16__["QosResultType"]; });

/* harmony import */ var _Api_ExecutionQueue__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./Api/ExecutionQueue */ "AhqE");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "_ExecutionQueue", function() { return _Api_ExecutionQueue__WEBPACK_IMPORTED_MODULE_17__["default"]; });
...
/***/ "shDo":
/*!****************************************!*\
  !*** ./lib/extraData/PromotedState.js ***!
  \****************************************/
/*! exports provided: PromotedState */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/******/ })});;
//# sourceMappingURL=sp-diagnostics_none_5429b595822d1886afe6.js.map