...
// Module
exports.push([module.i, ".b_b_d7d6ff7b{height:200px;border:1px solid \"[theme:neutraltertiary, default: #a19f9d]\";overflow:auto}.b_b_d7d6ff7b:hover{border-color:\"[theme:neutralDark, default: #201f1e]\"}.b_b_d7d6ff7b .c_b_d7d6ff7b{overflow:visible}.e_b_d7d6ff7b{cursor:pointer}.e_b_d7d6ff7b.f_b_d7d6ff7b .ms-DetailsRow{background-color:\"[theme:neutralLight, default: #edebe9]\"}.g_b_d7d6ff7b,.h_b_d7d6ff7b{font-size:14px;color:\"[theme:neutralPrimary, default: #323130]\"}.i_b_d7d6ff7b{font-size:14px;color:\"[theme:neutralSecondary, default: #605e5c]\"}.j_b_d7d6ff7b{padding-bottom:4px}.j_b_d7d6ff7b,.k_b_d7d6ff7b{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;word-wrap:normal}.k_b_d7d6ff7b{color:\"[theme:neutralTertiary, default: #a19f9d]\"}.k_b_d7d6ff7b,.l_b_d7d6ff7b{font-size:12px}[dir=ltr] .l_b_d7d6ff7b{padding-left:10px}[dir=rtl] .l_b_d7d6ff7b{padding-right:10px}.m_b_d7d6ff7b{height:100%;display:-ms-flexbox;display:flex;overflow:hidden}", ""]);
...
var styles = {
    screenReaderAlert: 'a_a_d7d6ff7b'
};
...
var styles = {
    suggestions: 'b_b_d7d6ff7b',
    suggestionsList: 'c_b_d7d6ff7b',
    suggestionsRow: 'e_b_d7d6ff7b',
    isRowSelected: 'f_b_d7d6ff7b',
    suggestionsHeader: 'g_b_d7d6ff7b',
    suggestionsTitleColumn: 'h_b_d7d6ff7b',
    suggestionsOtherColumn: 'i_b_d7d6ff7b',
    suggestionsTitlePrimaryText: 'j_b_d7d6ff7b',
    suggestionsTitleSecondaryText: 'k_b_d7d6ff7b',
    currentPage: 'l_b_d7d6ff7b',
    spinner: 'm_b_d7d6ff7b'
};
/* harmony default export */ __webpack_exports__["default"] = (styles);
/* tslint:enable */ 
...
module.exports = JSON.parse("{\"DialogTitle\":\"[!!--##Ĩńśēŕţ ĺĩńķ##--!!]\",\"UrlTextFieldLabel\":\"[!!--##Àďďŕēśś##--!!]\",\"UrlTextFieldAriaLabel\":\"[!!--##Ŵēƀ àďďŕēśś ţō ĺĩńķ ţō##--!!]\",\"UrlTextFieldError\":\"[!!--##Ţĥĩś ĺĩńķ ţŷƥē ĩś ńōţ śũƥƥōŕţēď.##--!!]\",\"TitleTextFieldLabel\":\"[!!--##Ţēxţ ţō ďĩśƥĺàŷ##--!!]\",\"RecentPagesLabel\":\"[!!--##Mōśţ ŕēćēńţ ƥàĝēś ōń ţĥĩś śĩţē##--!!]\",\"SearchForPagesLabel\":\"[!!--##Ƥàĝēś ōń ţĥĩś śĩţē ţĥàţ màţćĥ ŷōũŕ śēàŕćĥ##--!!]\",\"RecentSpacesLabel\":\"[!!--##Mōśţ ŕēćēńţ śƥàćēś ōń ţĥĩś śĩţē##--!!]\",\"SearchForSpacesLabel\":\"[!!--##Śƥàćēś ōń ţĥĩś śĩţē ţĥàţ màţćĥ ŷōũŕ śēàŕćĥ##--!!]\",\"NoResultLabel\":\"[!!--##Ńō ĩţēmś màţćĥ ŷōũŕ śēàŕćĥ##--!!]\",\"TryAgainLabel\":\"[!!--##Ţŕŷ à ďĩƒƒēŕēńţ ķēŷŵōŕď##--!!]\",\"OpenLinkInNewTabLabel\":\"[!!--##Ōƥēń ĺĩńķ ĩń à ńēŵ ţàƀ##--!!]\",\"SaveButtonLabel\":\"[!!--##Śàvē##--!!]\",\"CancelButtonLabel\":\"[!!--##Ćàńćēĺ##--!!]\",\"UnlinkButtonLabel\":\"[!!--##Ŕēmōvē ĺĩńķ##--!!]\",\"TitleSuggestionsColumnName\":\"[!!--##Ţĩţĺē##--!!]\",\"EditorSuggestionsColumnName\":\"[!!--##Mōďĩƒĩēď ƀŷ##--!!]\",\"ModifiedSuggestionsColumnName\":\"[!!--##Mōďĩƒĩēď##--!!]\",\"PageContentContainsSearchText\":\"[!!--##\\u0022{0}\\u0022 ƒōũńď ĩń ƥàĝē ćōńţēńţś##--!!]\",\"CurrentPage\":\"[!!--##(ćũŕŕēńţ ƥàĝē)##--!!]\",\"SearchTextFieldLabel\":\"[!!--##Śēàŕćĥ##--!!]\",\"SearchPagesTextFieldPlaceholder\":\"[!!--##Ēńţēŕ ķēŷŵōŕďś ţō śēàŕćĥ ƒōŕ ƥàĝēś ōń ţĥĩś śĩţē##--!!]\",\"SearchSpacesTextFieldPlaceholder\":\"[!!--##Ēńţēŕ ķēŷŵōŕďś ţō śēàŕćĥ ƒōŕ śƥàćēś ōń ţĥĩś śĩţē##--!!]\",\"DialogAriaDescription\":\"[!!--##Ĩńśēŕţ à ĺĩńķ ţō à ƥàĝē ōń ţĥē ćũŕŕēńţ śĩţē ōŕ ţō à ƥàĝē ōń àńōţĥēŕ śĩţē.##--!!]\",\"SuggestionsListAriaLabel\":\"[!!--##Śēĺēćţ à ƥàĝē ƒŕōm ţĥē {0} ĺĩśţ. Ƥŕēśś ţĥē Ũƥ àńď Ďōŵń àŕŕōŵ ķēŷś ţō ńàvĩĝàţē ţĥŕōũĝĥ ţĥē ƥàĝēś. Ƥŕēśś ţĥē Ēńţēŕ ķēŷ ţō śēĺēćţ à ƥàĝē. Ŵĥēń à ƥàĝē ĩś śēĺēćţēď, ţĥē ƥàĝē ĺĩńķ ŵĩĺĺ ƀē ũśēď ĩń ţĥē Ĺĩńķ ĩńƥũţ ƀōx, àńď, ĩƒ ţĥēŕē ĩś ńō ţēxţ ĩń ţĥē Ţēxţ ţō ďĩśƥĺàŷ ĩńƥũţ ƀōx, ţĥē ƥàĝē ţĩţĺē ŵĩĺĺ ƀē ũśēď.##--!!]\",\"SaveButtonDisabledScreenReaderAlert\":\"[!!--##Ţĥē Śàvē ƀũţţōń ĩś ńōţ àvàĩĺàƀĺē ƀēćàũśē àń ĩńvàĺĩď ŵēƀ àďďŕēśś ŵàś ēńţēŕēď.##--!!]\",\"SaveButtonEnabledScreenReaderAlert\":\"[!!--##Ţĥē Śàvē ƀũţţōń ĩś àvàĩĺàƀĺē.##--!!]\",\"PageIsSelectedScreenReaderAlert\":\"[!!--##Ţĥē ƥàĝē {0} ĩś śēĺēćţēď.##--!!]\",\"IsSearching\":\"[!!--##Śēàŕćĥĩńĝ...##--!!]\",\"SearchResultsShowing\":\"[!!--##Śēàŕćĥ ŕēśũĺţś àŕē ďĩśƥĺàŷēď. Ƥŕēśś Ţàƀ ţō ĝō ţō ţĥē Śēàŕćĥ ŕēśũĺţś ĺĩśţ.##--!!]\",\"RecentPagesShowing\":\"[!!--##À ĺĩśţ ōƒ ŕēćēńţ ƥàĝēś ĩś ďĩśƥĺàŷēď. Ƥŕēśś Ţàƀ ţō ĝō ţō ţĥē Ŕēćēńţ ƥàĝēś ĺĩśţ.##--!!]\"}");
...
exports = module.exports = __webpack_require__(/*! ../../../../../common/temp/node_modules/.pnpm/css-loader@3.2.1_webpack@4.44.2/node_modules/css-loader/dist/runtime/api.js */ "5ADk")(false);
// Module
exports.push([module.i, ".a_a_d7d6ff7b{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);border:0}", ""]);
...
//# sourceMappingURL=chunk.page-picker-component_[locale]_30ee2d489ab52fb0d66c.js.map