...
/******/ 	  var regex = (typeof spScriptNamePattern !== 'undefined') ? spScriptNamePattern : /sp-webpart-shared_en-us_4dc40cf6ec81bca68ddf\.js/i;
/******/ 	  var publicPath;
/******/
...
module.exports = JSON.parse("{\"DefaultMonthText\":\"Month\"}");
...
module.exports = JSON.parse("{\"RelativeDateTime_DayAndTime\":\"{0} at {1}\"}");
...
module.exports = JSON.parse("{\"Page\":\"Page {0}\",\"PaginationPrev\":\"Previous\",\"PaginationNext\":\"Next\",\"PrevNextButtonAriaLabel\":\"Go to the {0} page, you are currently on page {1}.\",\"PrevNextButtonCompactModeAriaLabel\":\"Go to the {0} page.\"}");
...
module.exports = JSON.parse("{\"MultiFactorAuthMessage\":\"We need you to sign in again. Once you do, we\\u0027ll bring you back here.\",\"LoginButtonLabel\":\"Continue\"}");
...
module.exports = JSON.parse("{\"SeeAllLink\":\"See all\",\"SeeAllLinkAriaLabel\":\"See all. Press enter to browse all items.\",\"AddButtonLabel\":\"Add\",\"AddButtonAriaLabel\":\"Add an item\",\"CloseTeachingBubbleAriaLabel\":\"Close teaching bubble\",\"SeeAllPageLoadingAlertTemplate\":\"The See All page for the {0} web part is opening.\"}");
