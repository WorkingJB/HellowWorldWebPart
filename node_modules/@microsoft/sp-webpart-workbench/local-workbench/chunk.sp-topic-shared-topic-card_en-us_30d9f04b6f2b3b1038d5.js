...
var styles = {
    spLikesPersonaBox: 'b_b_04103875',
    spLikesPersona: 'c_b_04103875',
    spLikesPersonaText: 'e_b_04103875',
    personDescription: 'f_b_04103875',
    personaLayoutFix: 'g_b_04103875'
};
...
// Module
exports.push([module.i, ".p_e_04103875{position:fixed;bottom:0;width:100%}.q_e_04103875{background-color:\"[theme:themeLighterAlt, default: #eff6fc]\"}.r_e_04103875{margin:0 16px 16px 0}[dir=rtl] .r_e_04103875{margin:0 0 16px 16px}[dir=ltr] .s_e_04103875{margin-right:5px}[dir=rtl] .s_e_04103875{margin-left:5px}.t_e_04103875{min-width:-webkit-fit-content;min-width:-moz-fit-content;min-width:fit-content;margin:0}.u_e_04103875{display:-ms-flexbox;display:flex;-ms-flex-pack:end;justify-content:flex-end}.v_e_04103875{margin:12px 8px 12px 16px}[dir=rtl] .v_e_04103875{margin:12px 16px 12px 8px}.w_e_04103875{font-size:14px;line-height:20px}.w_e_04103875 .x_e_04103875,.y_e_04103875{font-weight:600}.y_e_04103875{font-size:14px}.z_e_04103875{padding:0;margin-top:8px;margin-right:8px;width:auto}", ""]);
...
exports = module.exports = __webpack_require__(/*! ../../../../../common/temp/node_modules/.pnpm/css-loader@3.2.1_webpack@4.44.2/node_modules/css-loader/dist/runtime/api.js */ "5ADk")(false);
// Module
exports.push([module.i, ".b_b_04103875{padding:7px 0;vertical-align:middle}.b_b_04103875 .c_b_04103875{border-radius:50%;vertical-align:middle}[dir=ltr] .b_b_04103875 .c_b_04103875{margin-right:10px}[dir=rtl] .b_b_04103875 .c_b_04103875{margin-left:10px}.b_b_04103875 .e_b_04103875{font-size:14px;font-weight:400;color:\"[theme:bodyText, default: #323130]\";vertical-align:middle}.b_b_04103875 .f_b_04103875{font-size:12px;display:-webkit-box;-webkit-box-orient:vertical;overflow:hidden;-webkit-line-clamp:2;word-break:break-all}.b_b_04103875.g_b_04103875{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center}", ""]);
...
var styles = {
    messageBarContainer: 'p_e_04103875',
    messageBar: 'q_e_04103875',
    messageBarActionButton: 'r_e_04103875',
    messageBarButtonLeft: 's_e_04103875',
    messageBarIconContainer: 't_e_04103875',
    responseOptionContainer: 'u_e_04103875',
    textContainer: 'v_e_04103875',
    text: 'w_e_04103875',
    semibold: 'x_e_04103875',
    responseOption: 'y_e_04103875',
    dismissButton: 'z_e_04103875'
};
/* harmony default export */ __webpack_exports__["default"] = (styles);
/* tslint:enable */ 
...
module.exports = JSON.parse("{\"userPhotoAlt\":\"Photo of {0}\"}");
...
var styles = {
    ...
    personDescription: 'f_g_04103875',
...
module.exports = JSON.parse("{\"HighlightShortenedQuestion\":\"Should this highlight be here?\",\"ListingShortenedQuestion\":\"Should {0} be listed?\",\"DefinitionShortenedQuestion\":\"Is the description correct?\",\"Thanks\":\"Thanks!\",\"ConfirmTopicQuestionContext\":\"was highlighted because it was automatically identified as a topic of interest to your organization.\",\"ConfirmTopicQuestion\":\"Should it be highlighted?\",\"LegacyConfirmTopicNegativeResponseConfirmation\":\"This topic will be considered for removal from your organization\\u0027s knowledge network.\",\"ConfirmTopicNegativeResponseConfirmation\":\"You\\u0027ve told us this topic may not be right for your organization.\",\"RemoveHighlightOnPageQuestion\":\"Would you rather remove the highlight from this page only?\",\"AnnotateOnPageQuestionContext\":\"was automatically identified as relevant to this page\\u0027s contents.\",\"AnnotateOnPageQuestion\":\"Is it relevant?\",\"HighlightsResponseConfirmation\":\"Your response will be used to improve topic highlights. Changed your mind?\",\"IsDefinitionAccurateContext\":\"The short description of {0} was automatically extracted from a related resource.\",\"IsDefinitionAccurateQuestion\":\"Does it describe the topic well?\",\"IsDefinitionAccurateConfirmation\":\"Your response will be used to improve descriptions of topics. Changed your mind?\",\"IsPersonRelatedQuestionContext\":\"was automatically identified as connected to this topic.\",\"IsFileRelatedQuestionContext\":\"The resource {0} was automatically identified as connected to this topic.\",\"IsRelatedQuestion\":\"Is the connection correct?\",\"IsRelatedConfirmation\":\"Your response will be used to improve automatic identification of connections. Changed your mind?\",\"PositiveResponse\":\"Yes\",\"NegativeResponse\":\"No\",\"Undo\":\"Undo\",\"CloseButtonAriaLabel\":\"Close topic feedback\",\"CloseButtonTooltip\":\"Close\"}");
...
module.exports = JSON.parse("{\"TopicFeedbackLabel\":\"Give feedback\",\"TopicFeedbackTooltip\":\"Send an email message to the Project Cortex topic experiences team\"}");
...
module.exports = JSON.parse("{\"DefaultDescription\":\"We haven\\u0027t found a description yet.\",\"DescriptionPlaceholder\":\"Edit {0} to add a definition.\",\"DescriptionPlaceholderV2\":\"A short description will appear as soon as it\\u0027s available\",\"DocumentSectionTitle\":\"Resources\",\"SuggestedDocumentSectionTitle\":\"Suggested resources\",\"EditLabel\":\"Edit\",\"EditTopic\":\"Edit {0}\",\"ExpertSectionTitle\":\"People\",\"OpenTopicPage\":\"Show more\",\"PageLoading\":\"Loading…\",\"PeopleHeader\":\"People\",\"SuggestedPeopleHeader\":\"Suggested people\",\"SnippetSectionTitle\":\"Snippet:\",\"SourceSectionTitle\":\"Source\",\"Subtitle\":\"Improve what was discovered\",\"TopicTag\":\"Topic\",\"TopicTitleSettings\":\"Topic title settings\",\"TopicSubheader\":\"Improve what was discovered\",\"TopicSectionCountInterval\":\"0||1-10||11-\",\"TopicSectionCountTemplate\":\"|| ({0})|| (10+)\",\"SectionCount\":\"{0}{1}\",\"TopicNameWithAlternate\":\"{0}, {1}\",\"DescriptionAlternameNames\":\"Alternate names: {0}\",\"DescriptionSingleAlternameName\":\"Alternate name: {0}\",\"TopicCardDialogAriaLabel\":\"{0} Topic card\",\"PeopleCellAriaLabel\":\"{0}. Press Enter to open details for this person.\",\"ResourceItemAriaLabel\":\"{0}. {1}.\",\"TopicCardViewDetails\":\"View details\",\"TopicCardRelatedPersonDefaultDescription\":\"Contributed to resources\",\"TopicCardPersonContributedSingleDoc\":\"Contributed to {0}\",\"PersonAIReasonInterval\":\"2-10||11-\",\"PersonAIReasonTemplate\":\"Contributed to {0} resources||Contributed to many resources\",\"DocumentAIReasonInterval\":\"1||2-10||11-\",\"DocumentAIReasonTemplate\":\"Topic mentioned once in this file||Topic mentioned {0} times||Topic mentioned many times\",\"DocumentModifiedOn\":\"{0} modified {1}\",\"SuggestedTopicLabel\":\"SUGGESTED TOPIC\",\"SuggestedTopicBadgeTooltip\":\"This topic was automatically identified as a topic of interest for your organization.\",\"SiteTag\":\"Site\",\"TopicCardDocumentsAriaLabelNew\":\"{0}. {1}. {2} modified on {3}\",\"TopicCardOpenedAriaLabel\":\"Topic card opened\",\"TopicCardDismissButtonAriaLabel\":\"Close\",\"TopicCardAlternateName\":\"{0}, {1}\",\"SuggestedSiteDefaultAIReason\":\"Suggested based on resources\",\"TopicNameWithAlternateName\":\"{0} ({1})\"}");

/***/ })

}]);
//# sourceMappingURL=chunk.sp-topic-shared-topic-card_[locale]_30d9f04b6f2b3b1038d5.js.map