...
module.exports = JSON.parse("{\"AddedTemplate\":\"Added {0}\",\"DeletedTemplate\":\"Deleted {0} \",\"EditedTemplate\":\"Edited {0}\",\"MovedTemplate\":\"Moved {0}\",\"EditedAndMovedTemplate\":\"Edited and moved {0}\",\"EmphasisChangeTemplate\":\"Changed section background from {0} to {1}\",\"AddedCuratedTemplate\":\"{0}: Added {1} to curated\",\"RemovedCuratedTemplate\":\"{0}: Removed {1} from curated\",\"CuratedItemNamePlaceholder\":\"an item\"}");
...
module.exports = JSON.parse("{\"TextInsertTooltip\":\"Text inserted: {0}\",\"TextRemoveTooltip\":\"Text removed: {0}\",\"TextModifiedTooltip\":\"Text format changed: {0}\"}");
...
module.exports = JSON.parse("{\"RTETitle\":\"Text\",\"SectionBackgroundNeutralButtonLabel\":\"Neutral\",\"SectionBackgroundSoftButtonLabel\":\"Soft\",\"SectionBackgroundStrongButtonLabel\":\"Strong\",\"SectionBackgroundNoneButtonLabel\":\"None\"}");
