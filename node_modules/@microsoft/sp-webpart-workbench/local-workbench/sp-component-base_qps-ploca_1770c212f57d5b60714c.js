define("467dc675-7cc5-4709-8aac-78e3b71bd2f6_1.12.0", ["tslib","@microsoft/sp-dynamic-data","@microsoft/sp-lodash-subset","@microsoft/sp-core-library","@microsoft/sp-page-context","@microsoft/load-themed-styles","@microsoft/sp-diagnostics","@microsoft/sp-http"], function(__WEBPACK_EXTERNAL_MODULE__17wl__, __WEBPACK_EXTERNAL_MODULE__84nK__, __WEBPACK_EXTERNAL_MODULE_Pk8u__, __WEBPACK_EXTERNAL_MODULE_UWqr__, __WEBPACK_EXTERNAL_MODULE_X_PM__, __WEBPACK_EXTERNAL_MODULE_jOlS__, __WEBPACK_EXTERNAL_MODULE_ut3N__, __WEBPACK_EXTERNAL_MODULE_vlQI__) { return /******/ (function(modules) { // webpackBootstrap
...
/******/ 		return __webpack_require__.p + "chunk." + ({"legacy-third-party-fabric-core-localfont":"legacy-third-party-fabric-core-localfont"}[chunkId]||chunkId) + "_" + "none" + "_" + "1770c212f57d5b60714c" + ".js"
/******/ 	}
/******/
...
/******/
/******/ 	var jsonpArray = window["webpackJsonp_467dc675_7cc5_4709_8aac_78e3b71bd2f6_1_12_0"] = window["webpackJsonp_467dc675_7cc5_4709_8aac_78e3b71bd2f6_1_12_0"] || [];
...
/******/ 	  var regex = (typeof spScriptNamePattern !== 'undefined') ? spScriptNamePattern : /sp-component-base_qps-ploca_1770c212f57d5b60714c\.js/i;
/******/ 	  var publicPath;
/******/
...
var DynamicProperty = /** @class */ (function () {
    ...
    DynamicProperty.prototype._getData = function () {
        ...
        try {
            ...
            _microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_4__["_EngagementLogger"].logEventWithLogEntry(error);
            throw error;
        }
        _microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_4__["_EngagementLogger"].logEventWithLogEntry(new _microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_4__["_LogEntry"]('DynamicData', 'getData', _microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_4__["_LogType"].Event, { value: JSON.stringify(this.value) }));
        return value;
    };
    /**
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _styles_shimmer_module_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles/shimmer.module.scss */ "hGIM");
...
var DynamicDataProvider = /** @class */ (function () {
    ...
    Object.defineProperty(DynamicDataProvider.prototype, "_isProviderInitialized", {
        /**
         * Returns true if the Dynamic Data Provider is intialized.
         * @internal
         */
        get: function () {
    ...
    DynamicDataProvider.prototype.unregisterPropertyChanged = function (sourceId, propertyId, callback) {
        ...
        // registration is in pending state.
        if (!this.isRegistrationPending(registration)) {
        ...
        if (data && dataReference.propertyPath) {
            ...
            subpaths.forEach(function (subpath) {
                ...
                if (data) {
                    ...
                    else if (data.hasOwnProperty(subProperty)) {
    ...
    DynamicDataProvider.prototype._onSourcesChanged = function () {
        ...
        this._pendingRegistrations.forEach(function (src) {
            // register to sourceChanged event, if the source is available.
            if (availableSourceIds.indexOf(src.id) !== -1) {
                // Source is available
                if (!src.propertyId) {
                    // No propertyId, means register to sourceChanged event.
                    ...
                    // With propertyId, means register to propertyChanged event.
                ...
                _this._removePendingRegistration(src);
            }
        });
    };
    ...
    DynamicDataProvider.prototype._addPendingRegistration = function (registration) {
        if (!this.isRegistrationPending(registration)) {
            this._pendingRegistrations.set(registration.id + (registration.propertyId || ''), {
                id: registration.id,
    ...
    DynamicDataProvider.prototype._removePendingRegistration = function (registration) {
        this._pendingRegistrations.delete(registration.id + (registration.propertyId || ''));
    ...
    DynamicDataProvider.prototype.isRegistrationPending = function (incomingRegistration) {
        return this._pendingRegistrations.has(incomingRegistration.id + (incomingRegistration.propertyId || ''));
    };
    /**
...
var ThemeChangedEventArgs = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(ThemeChangedEventArgs, _super);
...
var ThemeProvider = /** @class */ (function () {
    ...
    function ThemeProvider(serviceScope, theme) {
        ...
        this.themeChangedEvent = new _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_1__["SPEvent"](this._themeChangedEventName);
        if (theme) {
    ...
    ThemeProvider.prototype._setTheme = function (theme) {
        _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_1__["Validate"].isNotNullOrUndefined(theme, 'theme');
        this._theme = Object.freeze(theme);
        this._raiseEvent();
    };
    /**
    ...
    ThemeProvider.prototype._raiseEvent = function () {
        _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_1__["_SPEventManager"].instance.raiseEvent(this._themeChangedEventName, {
            theme: this._theme
        });
    };
    /**
     ...
     */
    ThemeProvider.serviceKey = _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_1__["ServiceKey"].create('sp-component-base.ThemeProvider', ThemeProvider);
...
var DynamicDataSourceManager = /** @class */ (function () {
    function DynamicDataSourceManager() {
        ...
        this._isDisposed = false;
        this._isInitialized = false;
        this._logSource = _microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_1__["_LogSource"].create('DynamicDataSourceManager');
    }
    /**
    ...
    DynamicDataSourceManager.prototype._initialize = function (component, serviceScope) {
        _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_2__["Validate"].isNotNullOrUndefined(component, 'component');
        _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_2__["Validate"].isNotNullOrUndefined(serviceScope, 'serviceScope');
        this._component = component;
        this._dynamicDataManager = serviceScope.consume(_microsoft_sp_dynamic_data__WEBPACK_IMPORTED_MODULE_3__["_DynamicDataUtilities"].IDynamicDataManagerServiceKey);
        this._isInitialized = true;
    };
    /**
    ...
    DynamicDataSourceManager.prototype.initializeSource = function (callableFunctions) {
        ...
        this._assertInitialized();
        if (!!this._src) {
            throw new Error(_loc_Strings_resx__WEBPACK_IMPORTED_MODULE_6__["SourceAlreadyInitialized"]);
        }
    ...
    DynamicDataSourceManager.prototype.notifyPropertyChanged = function (propertyId) {
        _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_2__["Validate"].isNonemptyString(propertyId, 'propertyId');
        this._assertNotDisposed();
        this._assertInitialized();
        this._assertSourceExists();
    ...
    DynamicDataSourceManager.prototype.updateMetadata = function (metadata) {
        ...
        this._assertInitialized();
        this._assertSourceExists();
        _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_2__["Validate"].isNotNullOrUndefined(metadata, 'metadata');
        ...
        Object(_microsoft_sp_lodash_subset__WEBPACK_IMPORTED_MODULE_4__["merge"])(this._src.metadata, metadata);
    };
    ...
    DynamicDataSourceManager.prototype._buildSource = function (component) {
        ...
        if (this._callableFunctions.allowedEvents && this._callableFunctions.allowedEvents.length > 0) {
            if (!this._callableFunctions.sendEvent) {
                throw new Error(_loc_Strings_resx__WEBPACK_IMPORTED_MODULE_6__["NoSendEventWhenAllowedEventsIsNonEmpty"]);
            }
        }
        return {
    ...
    DynamicDataSourceManager.prototype._allowedEvents = function () {
        return this._callableFunctions.allowedEvents
            ? Object(_microsoft_sp_lodash_subset__WEBPACK_IMPORTED_MODULE_4__["cloneDeep"])(this._callableFunctions.allowedEvents())
            : undefined;
    };
    /**
    ...
    DynamicDataSourceManager.prototype._getPropertyDefinitions = function () {
        return Object(_microsoft_sp_lodash_subset__WEBPACK_IMPORTED_MODULE_4__["cloneDeep"])(this._callableFunctions.getPropertyDefinitions());
    };
    /**
    ...
    DynamicDataSourceManager.prototype._getPropertyValue = function (propertyId) {
        _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_2__["Validate"].isNotNullOrUndefined(propertyId, 'propertyId');
        var qosMonitor = new _microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_1__["_QosMonitor"]('DynamicDataSourceManager._getPropertyValue');
        ...
        try {
            ...
            qosMonitor.writeSuccess(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, ((this._src && this._src.metadata) || {})), { sourceId: this._src && this._src.id, propertyValue: propertyValue,
                propertyId: propertyId }));
            return Object(_microsoft_sp_lodash_subset__WEBPACK_IMPORTED_MODULE_4__["cloneDeep"])(propertyValue);
        }
        catch (error) {
    ...
    DynamicDataSourceManager.prototype._getAnnotatedPropertyValue = function (propertyId) {
        _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_2__["Validate"].isNotNullOrUndefined(propertyId, 'propertyId');
        var qosMonitor = new _microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_1__["_QosMonitor"]('DynamicDataSourceManager._getAnnotatedPropertyValue');
        ...
        if (getAnnotatedPropertyValue) {
            ...
            try {
                ...
                qosMonitor.writeSuccess(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, ((this._src && this._src.metadata) || {})), { sourceId: this._src && this._src.id, annotatedPropertyValue: annotatedPropertyValue,
                    propertyId: propertyId }));
            }
            catch (error) {
    ...
    DynamicDataSourceManager.prototype._assertValidEvent = function (eventName) {
        if (!this._allowedEvents() || Object(_microsoft_sp_lodash_subset__WEBPACK_IMPORTED_MODULE_4__["findIndex"])(this._allowedEvents(), { name: eventName }) === -1) {
            throw new Error(_microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_2__["Text"].format(_loc_Strings_resx__WEBPACK_IMPORTED_MODULE_6__["InvalidEvent"], eventName, this._src.metadata.title));
        }
    };
    DynamicDataSourceManager.prototype._assertNotDisposed = function () {
        if (this.isDisposed) {
            throw new Error(_loc_Strings_resx__WEBPACK_IMPORTED_MODULE_6__["DynamicDataSourceManagerIsDisposed"]);
        }
    };
    DynamicDataSourceManager.prototype._assertInitialized = function () {
        if (!this._isInitialized) {
            throw new Error(_loc_Strings_resx__WEBPACK_IMPORTED_MODULE_6__["DynamicDataSourceManagerIsNotInitialized"]);
        }
    };
    DynamicDataSourceManager.prototype._assertSourceExists = function () {
        if (!this._src) {
            throw new Error(_loc_Strings_resx__WEBPACK_IMPORTED_MODULE_6__["DynamicDataSourceIsNotInitialized"]);
        }
    };
    /**
    ...
    DynamicDataSourceManager.prototype._logFeatureEntry = function (logFeature, contextualProps) {
        ...
        var logEntry = new _microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_1__["_LogEntry"]('DynamicDataSourceManager', logFeature, _microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_1__["_LogType"].Event, _microsoft_sp_lodash_subset__WEBPACK_IMPORTED_MODULE_4__["merge"](logProperties, contextualProps));
        _microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_1__["_EngagementLogger"].logEventWithLogEntry(logEntry);
    };
...
/***/ "hGIM":
/*!****************************************!*\
  !*** ./lib/styles/shimmer.module.scss ***!
  \****************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
_microsoft_load_themed_styles__WEBPACK_IMPORTED_MODULE_0__["loadStyles"](".a_a_a3996340{position:relative;width:100%;margin:5px;height:100%;background-color:transparent}.b_a_a3996340{fill:#f4f4f4}", true);

// Exports
/* harmony default export */ __webpack_exports__["default"] = ({
  shimmerContainer: "a_a_a3996340",
  shimmerElementFill: "b_a_a3996340"
});
...
/*!******************************!*\
  ...
  \******************************/
/*! exports provided: SourceAlreadyInitialized, NoSendEventWhenAllowedEventsIsNonEmpty, DynamicDataSourceManagerIsDisposed, DynamicDataSourceManagerIsNotInitialized, DynamicDataSourceIsNotInitialized, InvalidEvent, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"SourceAlreadyInitialized\":\"Śōũŕćē ĥàś àĺŕēàďŷ ƀēēń ĩńĩţĩàĺĩźēď.\",\"NoSendEventWhenAllowedEventsIsNonEmpty\":\"\\u0022śēńďĒvēńţ()\\u0022 mũśţ ƀē ďēƒĩńēď, ŵĥēń ţĥē \\u0022àĺĺōŵēďĒvēńţś()\\u0022 ŕēţũŕńś à ńōń-ēmƥţŷ vàĺũē.\",\"DynamicDataSourceManagerIsDisposed\":\"Ďŷńàmĩć Ďàţà Śōũŕćē Màńàĝēŕ ĥàś ƀēēń ďĩśƥōśēď.\",\"DynamicDataSourceManagerIsNotInitialized\":\"Ďŷńàmĩć Ďàţà Śōũŕćē Màńàĝēŕ ĥàś ńōţ ƀēēń ĩńĩţĩàĺĩźēď.\",\"DynamicDataSourceIsNotInitialized\":\"Ďŷńàmĩć Ďàţà Śōũŕćē ĥàś ńōţ ƀēēń ĩńĩţĩàĺĩźēď.\",\"InvalidEvent\":\"\\u0022{0}\\u0022 ēvēńţ ĩś ńōţ àĺĺōŵēď ōń ţĥē śōũŕćē \\u0022{1}\\u0022\"}");
...
/*!**********************!*\
  !*** ./lib/index.js ***!
  \**********************/
/*! exports provided: BaseComponent, BaseComponentContext, DynamicDataProvider, DynamicDataSourceManager, DynamicProperty, _LegacyThirdPartyFabricCoreLoader, ThemeChangedEventArgs, ThemeProvider, _ShimmerFactory */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _ShimmerFactory__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ShimmerFactory */ "E99v");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "_ShimmerFactory", function() { return _ShimmerFactory__WEBPACK_IMPORTED_MODULE_7__["default"]; });
...
var LegacyThirdPartyFabricCoreLoader = /** @class */ (function () {
    ...
    LegacyThirdPartyFabricCoreLoader._shouldLoad = function (manifest) {
        return (!LegacyThirdPartyFabricCoreLoader.isLoaded &&
...
/******/ })});;
//# sourceMappingURL=sp-component-base_[locale]_1770c212f57d5b60714c.js.map