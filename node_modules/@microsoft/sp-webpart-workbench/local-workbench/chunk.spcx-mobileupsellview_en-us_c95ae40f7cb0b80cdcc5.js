...
// Module
exports.push([module.i, ".t_c_beed2cf1{bottom:0;height:30px;min-width:80px;text-align:center;display:inline-block;cursor:pointer}[dir=ltr] .t_c_beed2cf1{margin-right:20px}[dir=rtl] .t_c_beed2cf1{margin-left:20px}.t_c_beed2cf1.u_c_beed2cf1{z-index:11}@media print{.t_c_beed2cf1{display:none}}.v_c_beed2cf1{-ms-flex-align:end;align-items:flex-end;position:fixed;bottom:0;display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;z-index:6}[dir=ltr] .v_c_beed2cf1{right:20px}[dir=rtl] .v_c_beed2cf1{left:20px}@media screen and (max-width:480px){.v_c_beed2cf1{display:none}}", ""]);
...
var styles = {
    MobileUpsellView: 't_c_beed2cf1',
    originalZIndex: 'u_c_beed2cf1',
    MobileUpsellWrapper: 'v_c_beed2cf1'
};
...
module.exports = JSON.parse("{\"GetMobileAppButtonText\":\"Get the mobile app\"}");
...
//# sourceMappingURL=chunk.spcx-mobileupsellview_[locale]_c95ae40f7cb0b80cdcc5.js.map