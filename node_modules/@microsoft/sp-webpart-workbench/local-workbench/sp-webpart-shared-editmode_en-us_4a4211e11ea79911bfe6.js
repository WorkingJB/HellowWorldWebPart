...
/******/ 	  var regex = (typeof spScriptNamePattern !== 'undefined') ? spScriptNamePattern : /sp-webpart-shared-editmode_en-us_4a4211e11ea79911bfe6\.js/i;
/******/ 	  var publicPath;
/******/
...
module.exports = JSON.parse("{\"UploadWarningMessage\":\"We\\u0027re still uploading your image. It may get lost if you leave this page.\",\"PreviewAltTextWhileUploading\":\"Preview image that shows while an image is uploading.\",\"FileTypeError\":\"This doesn\\u0027t seem like a supported image file. Please select a different image.\"}");
...
module.exports = JSON.parse("{\"EnableLabel\":\"Enable audience targeting\",\"IconTooltip\":\"Enable audience targeting to promote content to specific audiences across the site.\",\"OnText\":\"On\",\"OffText\":\"Off\",\"OnAriaLabel\":\"Enabled audience targeting.\",\"OffAriaLabel\":\"Disabled audience targeting.\"}");
...
module.exports = JSON.parse("{\"UploadSecurityValidationTimeOutErrorMessage\":\"The security validation for this page has timed out. Refresh the page or use the back button in your browser to try again.\",\"UploadInvalidFileNameCharacterErrorMessage\":\"The file or folder {0} contains invalid characters such as # % * : < > ? / | and cannot be selected.\",\"UploadNoPermissionErrorMessage\":\"Access denied. You do not have permission to perform this action or access this resource.\",\"UnknownError\":\"Can\\u0027t upload this item. Refresh the page or use the back button in your browser to try again.\",\"UploadWarningMessage\":\"We\\u0027re still uploading your item. If you leave this page, uploading may not finish and you\\u0027ll have to try again.\"}");
