...
module.exports = JSON.parse("{\"ToolboxSearchAccessibleLabelTemplate\":\"Type here to search for a web part. {0}\",\"ToolboxSearchEscapeAccessibleLabel\":\"Press Escape to clear the existing search.\",\"ToolboxSearchLabel\":\"Search\"}");
...
module.exports = JSON.parse("{\"ToolboxCategoryTextMediaAndContent\":\"Text, media, and content\",\"ToolboxCategoryDiscovery\":\"Discovery\",\"ToolboxCategoryCommunicationAndCollaboration\":\"Communication and collaboration\",\"ToolboxCategoryPlanningAndProcess\":\"Planning and process\",\"ToolboxCategoryBusinessIntelligence\":\"Business and intelligence\",\"ToolboxCategorySiteTools\":\"Site tools\",\"ToolboxCategoryConnectors\":\"Connectors\",\"ToolboxCategoryOther\":\"Other\",\"ToolboxGroupNameFeatured\":\"Featured\",\"ToolboxGroupNameMostFrequently\":\"Frequently used\",\"ToolboxGroupNameAlphabetical\":\"Sort A-Z\",\"ToolboxGroupNameSection\":\"Section layout\"}");
...
module.exports = JSON.parse("{\"ToolboxCategoryAllCategory\":\"All\",\"ToolboxCategorySortingCategory\":\"Sort A-Z\",\"ToolboxCategorySearchResults\":\"Search results\",\"ToolboxCollapseButtonDescription\":\"Restore to original size\",\"NoResultLabel\":\"No items match your search\",\"TryAgainLabel\":\"Try a different keyword\",\"LargeToolboxAriaTitle\":\"Expanded web part toolbox.\",\"ToolboxCollapseButtonAriaLabel\":\"Collapse.\",\"DropDownMenuAriaLabel\":\"Showing web parts from {0} category.\",\"SwitchCategoryAlert\":\"Changed to {0}.\",\"BackButtonAriaLabel\":\"Go back to the previous view.\"}");
...
module.exports = JSON.parse("{\"ToolboxGroupSeeAllButtonLabel\":\"See all\",\"ToolboxGroupSeeAllButtonAriaLabel\":\"See all web parts in {0}.\",\"ToolboxGroupAriaLabel\":\"{0} web parts. Use left and right arrow keys to move between web parts.\",\"ToolboxGroupListViewAriaLabel\":\"{0} web parts. Use up and down arrow keys to move between web parts.\"}");
...
module.exports = JSON.parse("{\"ToolboxExpandButtonTitle\":\"Expand to see more web parts\",\"ToolboxNoItemsFound\":\"We couldn\\u0027t find anything that matches your search.\",\"ToolboxExpandButtonAriaLabel\":\"Expand.\",\"ToolboxDropdownlabel\":\"Filter by\",\"ToolboxDropdownSubmenuTitle\":\"Filter by category\",\"ToolboxCategoryAllCategory\":\"All\",\"ToolboxCategorySortingCategory\":\"Sort A-Z\",\"ToolboxCategorySearchResults\":\"Search results\",\"ToolboxSortAndFilterTooltop\":\"Sort and filter\",\"DropDownMenuAriaLabel\":\"Showing web parts from {0} category.\",\"SwitchCategoryAlert\":\"Changed to {0}.\",\"ListGridViewSwitcherAriaLabel\":\"Press Enter to switch between Grid view and List view.\"}");
...
module.exports = JSON.parse("{\"ToolboxCategoryAllCategory\":\"All\",\"ToolboxCategorySortingCategory\":\"Sort A-Z \",\"ToolboxCategorySearchResults\":\"Search results\",\"SwitchCategoryAlert\":\"Changed to {0}.\",\"SwitchViewAlert\":\"Changed to {0} view.\",\"ListViewName\":\"List\",\"GridViewName\":\"Grid\"}");
