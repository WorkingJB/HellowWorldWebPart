...
/******/ 		return __webpack_require__.p + "chunk." + ({"spcx-mobileupsellview":"spcx-mobileupsellview","vendors~shared-react-shyconductor":"vendors~shared-react-shyconductor","vendors~spcx-sitefooter":"vendors~spcx-sitefooter","vendors~data-sync-nucleus":"vendors~data-sync-nucleus"}[chunkId]||chunkId) + "_" + (["en-us","none"])[{"0":1,"spcx-mobileupsellview":0,"vendors~shared-react-shyconductor":1,"vendors~spcx-sitefooter":1,"vendors~data-sync-nucleus":1}[chunkId]] + "_" + "c95ae40f7cb0b80cdcc5" + ".js"
/******/ 	}
/******/
...
/******/ 	  var regex = (typeof spScriptNamePattern !== 'undefined') ? spScriptNamePattern : /sp-pages-core_en-us_c95ae40f7cb0b80cdcc5\.js/i;
/******/ 	  var publicPath;
/******/
...
module.exports = JSON.parse("{\"poweredBy\":\"Powered by SharePoint communication sites.\",\"createSite\":\"Click here to create your own.\",\"mobileUpsell\":\"Get Mobile App\",\"mobileUpsellAria\":\"get mobile app footer control\",\"edit\":\"Edit\",\"editAriaLabel\":\"Edit site footer links\",\"companyLogoAlt\":\"Company logo\",\"EditNavFooterTitle\":\"Edit footer\"}");
...
var styles = {
    leftNavPlaceHolder: 'w_e_beed2cf1',
    leftNavWidthKS: 'x_e_beed2cf1'
};
/* harmony default export */ __webpack_exports__["default"] = (styles);
/* tslint:enable */ 
...
module.exports = JSON.parse("{\"pageFailedToPreload\":\"Error preloading the page-based application. Error: {0}\",\"pageFailedToLoadService\":\"Error loading service required to start the page-based application. Error: {0}\",\"failureToLoadRenderingService\":\"Error loading rendering service. Error: {0}\",\"failureToLoadStoreManagementService\":\"Error loading store management service. Error: {0}\",\"failureToLoadRoutingService\":\"Error loading routing service. Error: {0}\",\"failureToloadSuiteNavManager\":\"Error loading suite navigation configuration manager. Error: {0}\",\"failureToloadA11yManager\":\"Error loading custom accessibility management service. Error: {0}\",\"failureToLoadWebViewCommunicationService\":\"Error loading web view communicator service. Error: {0}\",\"failureToLoadServiceWorkerProxyService\":\"Error loading service worker proxy service. Error: {0}\",\"serviceWorkerNotSupported\":\"navigator.serviceWorker isn\\u0027t supported.\",\"failureToloadSocketService\":\"Error loading socket service. Error: {0}\",\"failureToRegisterService\":\"Service: {0} has already been registered.\",\"failureToGetConnection\":\"Failed to get connection. Error: Connection is not initialized.\",\"failureToStartConnection\":\"Failed to start connection. Error: Connection is not initialized.\",\"failureToStartConnectionPendingRequest\":\"Failed to start connection. Error: Pending request in progress.\",\"failureToStopConnectionNotInitialized\":\"Failed to stop connection. Error: Connection is not initialized.\",\"failureToStopConnectionNotStarted\":\"Failed to stop connection. Error: Connection has not started.\",\"failureToRegisterHandlersNoProxy\":\"Failed to register handlers. Error: No connection proxy available.\",\"failureToInitiateRequestNoProxy\":\"Failed to initiate data request. Error: No connection proxy available.\"}");
...
exports = module.exports = __webpack_require__(/*! ../../../../../../../common/temp/node_modules/.pnpm/css-loader@3.2.1_webpack@4.44.2/node_modules/css-loader/dist/runtime/api.js */ "5ADk")(false);
// Module
exports.push([module.i, ".w_e_beed2cf1{background-color:\"[theme:white, default: #ffffff]\";border:0 solid \"[theme:neutrallight, default: #edebe9]\";width:206px;-ms-flex:none;flex:none}[dir=ltr] .w_e_beed2cf1{border-right-width:1px}[dir=rtl] .w_e_beed2cf1{border-left-width:1px}@media screen and (max-width:1023px){.w_e_beed2cf1{display:none}}.x_e_beed2cf1{width:227px}", ""]);
...
/******/ })});;
//# sourceMappingURL=sp-pages-core_[locale]_c95ae40f7cb0b80cdcc5.js.map