...
// Module
exports.push([module.i, ".e_c_32f825c4{font-weight:700}", ""]);
...
module.exports = JSON.parse("{\"RTETitle\":\"[!!--##Ţēxţ##--!!]\"}");
...
module.exports = JSON.parse("{\"TextInsertTooltip\":\"[!!--##Ţēxţ ĩńśēŕţēď: {0}##--!!]\",\"TextRemoveTooltip\":\"[!!--##Ţēxţ ŕēmōvēď: {0}##--!!]\",\"TextModifiedTooltip\":\"[!!--##Ţēxţ ƒōŕmàţ ćĥàńĝēď: {0}##--!!]\"}");
...
module.exports = JSON.parse("{\"AddedTemplate\":\"[!!--##Àďďēď {0}##--!!]\",\"DeletedTemplate\":\"[!!--##Ďēĺēţēď {0} ##--!!]\",\"EditedTemplate\":\"[!!--##Ēďĩţēď {0}##--!!]\",\"MovedTemplate\":\"[!!--##Mōvēď {0}##--!!]\",\"EditedAndMovedTemplate\":\"[!!--##Ēďĩţēď àńď mōvēď {0}##--!!]\",\"EmphasisChangeTemplate\":\"[!!--##Ćĥàńĝēď śēćţĩōń ƀàćķĝŕōũńď ƒŕōm {0} ţō {1}##--!!]\",\"AddedCuratedTemplate\":\"[!!--##{0}: Àďďēď {1} ţō ćũŕàţēď##--!!]\",\"RemovedCuratedTemplate\":\"[!!--##{0}: Ŕēmōvēď {1} ƒŕōm ćũŕàţēď##--!!]\",\"CuratedItemNamePlaceholder\":\"[!!--##àń ĩţēm##--!!]\"}");
...
//# sourceMappingURL=chunk.sp-canvas-diff_[locale]_e5363a42ae1af379feef.js.map