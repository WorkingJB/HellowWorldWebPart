...
// Module
exports.push([module.i, ".h_c_04103875{font-family:Segoe UI,-apple-system,BlinkMacSystemFont,Roboto,Helvetica Neue,sans-serif;margin:0;width:288px;position:absolute;border:none;background:\"[theme:white, default: #ffffff]\";border-radius:2px;box-shadow:0 6.4px 14.4px 0 rgba(0,0,0,.132),0 1.2px 3.6px 0 rgba(0,0,0,.108);z-index:999}.i_c_04103875{transform:rotate(45deg);height:16px;width:16px;background-color:inherit;box-shadow:inherit;border:inherit;position:absolute;top:-8px}.j_c_04103875{position:relative;border:none}.k_c_04103875{position:absolute;top:14px}[dir=ltr] .k_c_04103875{right:14px}[dir=rtl] .k_c_04103875{left:14px}.l_c_04103875{padding:17px 28px;position:relative;background:\"[theme:white, default: #ffffff]\";border-radius:2px}.m_c_04103875{font-size:\"[theme:xLargeFontSize, default: 20px]\";font-weight:\"[theme:xLargeFontWeight, default: 600]\";line-height:1.4;color:\"[theme:neutralPrimary, default: #323130]\";margin:0;padding:0;height:100%}.n_c_04103875{margin-top:10px;color:\"[theme:neutralPrimary, default: #323130]\"}.n_c_04103875,.o_c_04103875{font-size:\"[theme:smallPlusFontSize, default: 12px]\";font-weight:\"[theme:smallPlusFontWeight, default: 400]\";line-height:1.8}.o_c_04103875{color:\"[theme:themePrimary, default: #0078d4]\";white-space:nowrap;overflow:hidden;text-overflow:ellipsis;display:inline}", ""]);
...
var styles = {
    container: 'h_c_04103875',
    beak: 'i_c_04103875',
    closeButtonContainer: 'j_c_04103875',
    closeButton: 'k_c_04103875',
    content: 'l_c_04103875',
    title: 'm_c_04103875',
    description: 'n_c_04103875',
    link: 'o_c_04103875'
};
...
module.exports = JSON.parse("{\"CalloutTitle\":\"Topic created\",\"CalloutDescription\":\"You\\u0027re in the list of people connected to the new topic. To change the list or other details go to the {0} topic page.\",\"CalloutCloseButtonAriaLabel\":\"Close\"}");

/***/ })

}]);
//# sourceMappingURL=chunk.topic-shared-topic-association-callout_[locale]_30d9f04b6f2b3b1038d5.js.map