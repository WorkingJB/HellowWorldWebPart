...
function getPropertyFromVSCode(property) {
    ...
    function loadProperty(...pathSegments) {
        const fullPath = path$2.join(...pathSegments, vsCodeFolder, ...settingsPath);
...
function tryStat(path) {
  ...
  try {
    return fs__default.statSync(path);
  } catch (e) {
    return undefined;
  }
}
...
Mime.prototype.load = function(file) {
  ...
  var map = {},
      content = fs__default.readFileSync(file, 'ascii'),
      lines = content.split(/[\r\n]+/);
...
SendStream.prototype.sendFile = function sendFile (path) {
  ...
  debug$9('stat "%s"', path);
  fs__default.stat(path, function onstat (err, stat) {
  ...
  function next (err) {
    ...
    debug$9('stat "%s"', p);
    fs__default.stat(p, function (err, stat) {
      if (err) return next(err)
...
SendStream.prototype.stream = function stream (path, options) {
  ...
  // pipe
  var stream = fs__default.createReadStream(path, options);
...
var utils_1 = utils.etag;
var utils_2 = utils.wetag;
var utils_3 = utils.isAbsolute;
var utils_4 = utils.flatten;
var utils_5 = utils.normalizeType;
var utils_6 = utils.normalizeTypes;
var utils_7 = utils.contentDisposition;
var utils_8 = utils.compileETag;
var utils_9 = utils.compileQueryParser;
var utils_10 = utils.compileTrust;
var utils_11 = utils.setCharset;
...
function sha1(str){
  return crypto__default.createHash('sha1').update(str).digest('hex');
}
});
...
var normalizeType$1 = utils.normalizeType;
    ...
    acquireTokenFromBrowser(scopeArray) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => tslib.__awaiter(this, void 0, void 0, function* () {
                ...
                const app = express$1();
                app.get("/", (req, res) => tslib.__awaiter(this, void 0, void 0, function* () {
                    const tokenRequest = {
                        code: req.query.code,
                        redirectUri: this.redirectUri,
                        scopes: scopeArray
